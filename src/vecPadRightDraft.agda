...
module vecPadRightDraft where

open import Data.Fin.Base using (Fin; zero; suc; inject≤; _↑ˡ_; inject+)
open import Data.Nat.Base using (ℕ; zero; suc; _+_; _≤_; z≤n; s≤s)
open import Data.Nat using (_⊔_)
open import Data.Nat.Properties using (≤-trans; m≤m+n)
open import Data.Vec.Base
open import Data.Vec.Properties using (map-replicate; zipWith-replicate; padRight-trans; map-++; lookup-++ˡ; zipWith-++)
