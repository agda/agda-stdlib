...
open import Data.List.Relation.Binary.Equality.Setoid S using (_≋_; ≋-refl; ≋-sym)
...
↭-isEquivalence = Homogeneous.isEquivalence ≋-refl ≋-sym ≈-sym

↭-setoid : Setoid _ _
↭-setoid = Homogeneous.setoid {PR = Pointwise _≈_} {R = _≈_} ≋-refl ≋-sym ≈-sym
