...
data Pointer {ℓ r : Level} {I : Set ℓ} {T : Rel I r} (P Q : EdgePred T)
...
Any : ∀ {ℓ r} {I : Set ℓ} {T : Rel I r} (P Q : EdgePred T) → EdgePred (Star T)
Any P Q xs = Star (Pointer P Q) (just (nonEmpty xs)) nothing

this : ∀ {ℓ r} {I : Set ℓ} {T : Rel I r} {P Q : EdgePred T}
             {i j k} {x : T i j} {xs : Star T j k} →
       Q x → Any P Q (x ◅ xs)
this q = done q ◅ ε

that : ∀ {ℓ r} {I : Set ℓ} {T : Rel I r} {P Q : EdgePred T}
       {i j k} {x : T i j} {xs : Star T j k} →
...
data Result {ℓ r : Level} {I : Set ℓ} (T : Rel I r) (P Q : EdgePred T) : Set (ℓ ⊔ r) where
  result : ∀ {i j} {x : T i j}
...
lookup : ∀ {ℓ r} {I : Set ℓ} {T : Rel I r} {P Q R : EdgePred T}
               {i j} {xs : Star T i j} →
...
prefixIndex : ∀ {ℓ r} {I : Set ℓ} {T : Rel I r} {P Q : EdgePred T}
                    {i j} {xs : Star T i j} →
              Any P Q xs → I
prefixIndex (done {i = i} q ◅ _)  = i
prefixIndex (step p         ◅ ps) = prefixIndex ps

prefix : ∀ {ℓ r} {I : Set ℓ} {T : Rel I r} {P Q : EdgePred T} {i j} {xs : Star T i j} →
...
init : ∀ {ℓ r} {I : Set ℓ} {T : Rel I r} {P Q : EdgePred T} {i j} {xs : Star T i j} →
...
last : ∀ {ℓ r} {I : Set ℓ} {T : Rel I r} {P Q : EdgePred T}
             {i j} {xs : Star T i j} →
