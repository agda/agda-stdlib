...
module _ (base : ℕ) where
  module _ {base≥2 : True (2 ≤? base)} where
  ...
  module _ {base≤16 : True (base ≤? 16)} where
    showDigit-injective : (n m : Digit base) → showDigit {base} {base≤16} n ≡ showDigit {base} {base≤16} m → n ≡ m
    showDigit-injective n m = inject≤-injective _ n m ∘ Uniqueₚ.lookup-injective digitCharsUnique _ _
