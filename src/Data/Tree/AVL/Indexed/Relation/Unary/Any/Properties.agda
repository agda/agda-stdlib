...
module _ {V : Value v}
  ...
  joinˡ⁺-here⁺ : ∀ {l u hˡ hʳ h} →
             ...
             (r : Tree V [ k ] u hʳ) →
             (bal : hˡ ∼ hʳ ⊔ h) →
             P k v → Any P (proj₂ (joinˡ⁺ kv l r bal))
  ...
  joinˡ⁺-left⁺ : ∀ {l u hˡ hʳ h} →
             (k : K& V) →
             (l : ∃ λ i → Tree V l [ proj₁ k ] (i ⊕ hˡ)) →
             (r : Tree V [ proj₁ k ] u hʳ) →
             (bal : hˡ ∼ hʳ ⊔ h) →
  ...
  joinʳ⁺-here⁺ : ∀ {l u hˡ hʳ h} →
            (kv@(k , v) : K& V) →
            (l : Tree V l [ k ] hˡ) →
            (r : ∃ λ i → Tree V [ k ] u (i ⊕ hʳ)) →
            (bal : hˡ ∼ hʳ ⊔ h) →
            P k v → Any P (proj₂ (joinʳ⁺ kv l r bal))
  ...
  joinʳ⁺-right⁺ : ∀ {l u hˡ hʳ h} →
            (k : K& V) →
            (l : Tree V l [ proj₁ k ] hˡ) →
            (r : ∃ λ i → Tree V [ proj₁ k ] u (i ⊕ hʳ)) →
            (bal : hˡ ∼ hʳ ⊔ h) →
            Any P (proj₂ r) → Any P (proj₂ (joinʳ⁺ k l r bal))
